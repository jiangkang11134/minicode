...
<p align="center">
  <strong>基于 MiniCode Python 的深度剖析与学习实践 — 添加了完整中文注释、架构分析和学习框架。</strong>
</p>
...
MiniCode Python 是一个轻量级的 AI coding agent 运行时。本 fork 在不改变原项目逻辑的前提下，对代码进行了全面的中文注释和架构分析，帮助开发者理解 agent 系统的核心设计。
